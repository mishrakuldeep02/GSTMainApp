<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmGSTR2File - Copy.aspx.cs" Inherits="CA_Admin_frmGSTR2File" %>
    ...
    <div id="submit" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are You Sure Submit Data.</p>
                </div>
                <div class="modal-footer">
              <asp:Button runat="server" ID="btnSubmit" class="btn btn-primary" OnClick="btnSubmit_Click" Text="Submit TO GSTIN" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p0">
                    <div class="table-responsive">
                        <asp:GridView runat="server" Visible="false" ID="grd" CssClass="table table-bordered mb0" AutoGenerateColumns="false">
                            <Columns>
