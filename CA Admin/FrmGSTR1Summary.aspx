<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="FrmGSTR1Summary.aspx.cs" Inherits="CA_Admin_FrmGSTR1Summary" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section>
        <div class="content-wrapper">
            ...
            <h3 class="second_heading">GSTR-1 Summary</h3>
            <div class="col-xs-12">
                <div class="row">
                            ...
                            <div id="pnlRegistration" runat="server" class="col-sm-12 col-xs-12" visible="true">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <asp:Button ID="btnGstr1Summary" runat="server" OnClick="btnGstr1Summary_Click" Text="Get GSTR1 Summary" CssClass="btn btn-primary" />
                                                <asp:Label ID="lblmsg" runat="server" ForeColor="Red"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="table-responsive mt-lg">
                                            <asp:GridView ID="GridGSTR1Summ" runat="server" class="table table-bordered" AutoGenerateColumns="false">
                                                <Columns>
