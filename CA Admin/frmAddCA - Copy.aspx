<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmAddCA - Copy.aspx.cs" Inherits="CA_Admin_frmAddCA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $('#<%=ddlCity.ClientID%>').focusin(function () { $('#ContentPlaceHolder1_ddlCity_chzn').focus(); });
    </script>
</asp:Content>
