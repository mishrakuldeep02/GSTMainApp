<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmCashITCBal.aspx.cs" Inherits="CA_Admin_frmCashITCBal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section>
        ...
        <div class="content-wrapper ">
            ...
            <h3 class="second_heading">Cash ITC Balance</h3>
            <div class="row">
                            ...
                            <div class="panel panel-default panel-demo">
                                <div class="panel-body">
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="">
                                            <asp:Button runat="server" ID="GetCashLedger" class="btn btn-primary" OnClick="GetCashLedger_Click" Text="Get ITC Balance" />
                                            <br />
                                            <br />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#<%=GetCashLedger.ClientID%>').click(function () { $('.loading').addClass('active'); });
