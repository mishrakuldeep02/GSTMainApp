<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmGstr2Importjson.aspx.cs" Inherits="CA_Admin_frmGstr2Importjson" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section>
        <div class="content-wrapper">
            ...
            <h3 class="second_heading">GSTR-2 Import Json</h3>
            <div class="row">
                    ...
                    <div class="row">
                        <div class="panel panel-default panel-demo">
                            <div class="panel-heading">
                                <h4 class="panel-title">GSTR-2 Import Json :
                                </h4>
                            </div>
    ...
    <div class="col-sm-8 col-xs-12">
        ...
        <div class="form-group">
            ...
            <label for="purchase" style="margin-left: 15px">
             ...
             <label class="col-lg-4 control-label text-left">Select Json File :</label>
            <div class="col-lg-8">
            <div class="input-group">
                <asp:FileUpload accept=".json" runat="server" ID="fuExcelImport" class="form-control" />
