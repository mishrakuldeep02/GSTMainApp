...
public partial class CA_Admin_frmGSTR2 : System.Web.UI.Page
{
    ...
    void GetGSTR2Data()
    {
        ...
        DataSet ds1 = CLSCommon.CallApiGet("api/GSTR2/GetGSTR2Data?ind=1&ClientCode=" + Session["ClientCode"].ToString() + "&ClientCodeOdp=" + Session["ClientCodeOdp"].ToString() + "&CaCode=" + Session["CaCode"].ToString() + "&CaCodeOdp=" + Session["CaCodeOdp"].ToString() + "&ClientGSTIN=" + Session["ClientGSTNNO"].ToString() + "&MonthCode=" + Session["MonthYrCode"].ToString());
