<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmImportTallySalesData.aspx.cs" Inherits="CA_Admin_frmImportTallySalesData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section>
        <div class="content-wrapper">
            ...
            <h3 class="second_heading">Import Tally Sales Data</h3>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="panel panel-default panel-demo">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Import Tally Sales Data :
                                    </h4>
                                </div>
                                        ...
                                        <div class="col-sm-8 col-xs-12">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-lg-4 control-label text-left">Select Tally Excel :</label>
                                                    <div class="col-lg-8">
                                                        <div class="input-group">
                                                            <asp:FileUpload accept=".xlsm,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" runat="server" ID="fuTallyExcelImport" class="form-control" />
