<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmGetLibLedger.aspx.cs" Inherits="CA_Admin_frmGetLibLedger" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <div class="panel panel-default panel-demo">
                                <div class="panel-body">
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="">
                                            <asp:Button runat="server" ID="btnGetLibLedger" class="btn btn-primary" OnClick="btnGetLibLedger_Click" Text="Get Liability Leder Deatils" />
                                            <br />
                                            <br />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#<%=btnGetLibLedger.ClientID%>').click(function () { $('.loading').addClass('active'); });
