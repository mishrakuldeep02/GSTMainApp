<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmGetGSTR1Data.aspx.cs" Inherits="CA_Admin_frmGetGSTR1Data" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section>
        ...
        <div class="content-wrapper ">
            ...
            <h3 class="second_heading">Get GSTR-1 Data</h3>
            <div class="row">
                            ...
                            <div class="panel panel-default panel-demo">
                                <div class="panel-body">
                                      <div class="col-sm-3 col-xs-12">
                                          <asp:DropDownList runat="server" ID="ddlGstr1Type" CssClass="form-control">
                                              <asp:ListItem Text="B2B" Value="GET_B2B"></asp:ListItem>
                                              <asp:ListItem Text="B2CL" Value="Get_B2CL"></asp:ListItem>
                                              <asp:ListItem Text="CDNR" Value="Get_CDNR"></asp:ListItem>
                                              <asp:ListItem Text="CDNUR" Value="Get_CDNUR"></asp:ListItem>
                                              <asp:ListItem Text="B2CS" Value="Get_B2CS"></asp:ListItem>
                                              <asp:ListItem Text="EXP" Value="Get_Exp"></asp:ListItem>
                                              <asp:ListItem Text="EXMPT" Value="Get_Exmpt"></asp:ListItem>
                                              <asp:ListItem Text="AT" Value="Get_AT"></asp:ListItem>
                                              <asp:ListItem Text="ATADJ" Value="Get_TXP"></asp:ListItem>
                                              <asp:ListItem Text="HSN" Value="Get_HSN"></asp:ListItem>
                                              <asp:ListItem Text="DOC" Value="Get_Doc"></asp:ListItem>

                                          </asp:DropDownList>
                                          </div>
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="">
                                            <asp:Button runat="server" ID="btnGSTR1Data" class="btn btn-primary" OnClick="btnGSTR1Data_Click" Text="Get Data" />
                                            <br />
                                            <br />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#<%=btnGSTR1Data.ClientID%>').click(function () { $('.loading').addClass('active'); });
