<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmRegisterDSCProd.aspx.cs" Inherits="CA_Admin_frmRegisterDSCProd" %>
        ...
        <div class="content-wrapper ">
            ...
            <div class="row">
                ...
                <div class="col-md-9 pull-left">
                    ...
                    <div class="row" id="divRegisterDSC" runat="server" visible="false">
                        <div class="panel-group">
                            <!-- START 1 panel-->
                            <div class="panel panel-default panel-demo">
                                <div class="panel-body">
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="">
                                            <asp:Button runat="server" ID="btnUploadHasg" class="btn btn-primary" OnClick="btnUploadHasg_Click" Text="Upload Hash" />
                                            <br />
                                            <br />
                                            ...
                                            <br />
                                            <asp:Label runat="server" ID="lblUploadStatus"></asp:Label>
                                        </div>
