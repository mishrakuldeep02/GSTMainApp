<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmGSTR1File.aspx.cs" Inherits="CA_Admin_frmGSTR1File" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="modal-dialog min890">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p0">
                    ...
                    <asp:GridView ID="GridGSTR1Summ" runat="server" class="table table-bordered tdp03" AutoGenerateColumns="false">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Total Invoice No" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblTotInvoice" runat="server" Text='<%#Eval("ttl_rec") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
    ...
    <section>
        ...
        <div class="content-wrapper ">
            ...
            <h3 class="second_heading">File GSTR-1</h3>
            <div class="row">
                                    ...
                                    <div runat="server" style="display: none; margin-top: 10px; margin-bottom: 0" id="divOTPSuccess" class="col-sm-12 col-xs-12 alert alert-success success">
                                      ...
                                      <%--   <asp:Label runat="server" ID="lblRemaining" Visible="false"></asp:Label>--%>
                                        ...
                                        <div class="clock-box">
                                            ...
                                            <div class="clock-col asd-hrs hour-animation">00</div>
                                            ...
                                            <table runat="server" visible="false" id="tblInvoice" class="table table-bordered table-sm table-th-sm mrt3px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <%--<input type="button" onclick="$('#file').modal('show');"  value="View" class="btn btn-info btn-xs" />--%>
                            ...
                            <div class="panel panel-default panel-demo">
                                ...
                                <div class="panel-body">
                                    <div class="col-sm-8 col-xs-12">
                                        ...
                                        <div>
                                            <p><asp:Label runat="server" ID="lblSubmitMsg"></asp:Label></p>
                                        </div>
                                        <div class="mr40">
                            ...
                            <div class="panel panel-default panel-demo">
                                ...
                                <div class="panel-body">
                                    <div class="col-sm-8 col-xs-12">
                                        ...
                                        <asp:Button runat="server" Visible="false" ID="btnValidate" Text="Validate" OnClick="btnValidate_Click" />
                                        <div>
                                            <p></p>
                                        </div>
                                        <%--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#viewsubmit">View Summary</button>--%>
                                    ...
                                    <div class="col-sm-4 col-xs-12">
                                        <h5>Response Message</h5>
                                        <span><asp:Label runat="server" ID="lblFileMessage"></asp:Label></span>
                                        <br />
                                        <span> <asp:Label runat="server" ID="lblAckNo"></asp:Label></span>
                                    </div>
                                </div>
                            </div>
                        </div>
