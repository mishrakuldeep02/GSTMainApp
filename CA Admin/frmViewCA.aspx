<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmViewCA.aspx.cs" Inherits="CA_Admin_frmViewCA" %>
                            ...
                            <div id="pnlRegistration" runat="server" class="col-sm-12 col-xs-12" visible="true">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" DataKeyNames="CaCode,CaCodeOdp" OnRowCommand="grdAllClients_RowCommand" class="table table-bordered" ID="grdAllClients" AutoGenerateColumns="false">
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="CA Name" DataField="CaNameE" />
<%--                                                <asp:BoundField HeaderText="Firm Name" DataField="FirmName" />--%>
                                                ...
                                                <asp:BoundField HeaderText="Mobile No." DataField="CaMobileNo1" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" />
                                                <asp:BoundField HeaderText="Email ID" DataField="CaEmailid" />
                                                <asp:BoundField HeaderText="No Of Clients GSTIN" DataField="Column1" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center"  />
                                                ...
                                                <asp:BoundField Visible="false" DataField="CaCode" />
                                                <asp:BoundField Visible="false" DataField="CaCodeOdp" />
                                            </Columns>
                                        </asp:GridView>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="grdClientDetails" CssClass="table table-bordered table-client-search" AutoGenerateColumns="false">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Email Id" DataField="ContactEmailid" />
