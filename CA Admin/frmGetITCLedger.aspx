<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmGetITCLedger.aspx.cs" Inherits="CA_Admin_frmGetITCLedger" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <div class="panel panel-default panel-demo">
                                <div class="panel-body">
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="">
                                            <asp:Button runat="server" ID="btnGetItcLedger" class="btn btn-primary" OnClick="btnGetItcLedger_Click" Text="Get ITC Ledger" />
                                            <br />
                                            <br />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#<%=btnGetItcLedger.ClientID%>').click(function () { $('.loading').addClass('active'); });
