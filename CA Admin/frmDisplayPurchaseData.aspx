<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CommonMaster.master" AutoEventWireup="true" CodeFile="frmDisplayPurchaseData.aspx.cs" Inherits="CA_Admin_frmDisplayPurchaseData" %>
                                ...
                                <div class="panel-heading" style="padding-bottom: 14px">
                                    ...
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#table3">
                                            ...
                                            <span class="gstr_row_desc blue">Inward supplies received from a registered person other than the supplies attracting reverse charge (B2B)</span>
                                        </a>
                                    </h4>
                                </div>
                                        ...
                                        <table class="table table-bordered table-gstr table_psm table3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <%--<td class="c01" rowspan="2">&nbsp;</td>
                                                    <td class="c02" rowspan="2">&nbsp;</td>
                                                    <td class="c03" rowspan="2">&nbsp;</td>
                                                    <td class="c04" rowspan="2">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                    <td class="c06">&nbsp;</td>
                                                    <td class="c07">&nbsp;</td>
                                                    <td class="c08">&nbsp;</td>
                                    ...
                                    <div class="panel-table">
                                        ...
                                        <table class="table table-bordered table-gstr table_psm table4">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                     <td colspan="16" class="p0 b0">
                                                        <asp:GridView runat="server" OnRowDataBound="Grd4A_RowDataBound" DataKeyNames="ActionCode" CssClass="table table-gstr table_psm table4" ID="Grd4A" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                                  <asp:BoundField DataField="PurchGSTIN" ItemStyle-CssClass="c01 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceNo" ItemStyle-CssClass="c02 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceDate" ItemStyle-CssClass="c03 text-center" />
                                               ...
                                               <%-- <tr>
                                                ...
                                                <tr>
                                                     <td colspan="16" class="p0 b0">
                                                        <asp:GridView runat="server" OnRowDataBound="Grd4B_RowDataBound" DataKeyNames="ActionCode" CssClass="table table-gstr table_psm table4"  ID="Grd4B" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                                  <asp:BoundField DataField="PurchGSTIN" ItemStyle-CssClass="c01 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceNo" ItemStyle-CssClass="c02 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceDate" ItemStyle-CssClass="c03 text-center" />
                                                ...
                                                <tr>
                                                    <td colspan="16" class="p0 b0">
                                                        <asp:GridView runat="server" OnRowDataBound="grd4C_RowDataBound" DataKeyNames="ActionCode" CssClass="table table-gstr table_psm table4" ID="grd4C" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                                 <asp:BoundField DataField="PurchGSTIN" ItemStyle-CssClass="c01 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceNo" ItemStyle-CssClass="c02 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceDate" ItemStyle-CssClass="c03 text-center" />
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                     <td colspan="11" class="p0 b0">
                                                        <asp:GridView runat="server" OnRowDataBound="grd5A_RowDataBound" DataKeyNames="ActionCode" CssClass="table table-gstr table_psm table5" ID="grd5A" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                                <asp:BoundField DataField="PurchGSTIN" ItemStyle-CssClass="c01 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceNo" ItemStyle-CssClass="c02 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceDate" ItemStyle-CssClass="c03 text-center" />
                                               ...
                                               <%-- <tr>
                                                ...
                                                <tr>
                                                     <td colspan="11" class="p0 b0">
                                                        <asp:GridView runat="server" OnRowDataBound="grd5B_RowDataBound" DataKeyNames="ActionCode" CssClass="table table-gstr table_psm table5" ID="grd5B" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                                <asp:BoundField DataField="PurchGSTIN" ItemStyle-CssClass="c01 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceNo" ItemStyle-CssClass="c02 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceDate" ItemStyle-CssClass="c03 text-center" />
                                                ...
                                                <tr>
                                                    <td class="c01" colspan="6">Port code +No of BE=13 digits</td>
                                                    <td class="c07" colspan="2">Assessable Value</td>
                                                    <td class="c09">&nbsp;</td>
                                                    <td class="c10">&nbsp;</td>
                                                    <td class="c11">&nbsp;</td>
                                                </tr>--%>
                                ...
                                <div class="panel-heading" style="padding-bottom: 14px">
                                    ...
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#table6">
                                            ...
                                            <span class="gstr_row_desc blue">Amendments to details of inward supplies furnished in returns for earlier tax periods in Tables 3, 4 and 5
[including debit notes/credit notes issued and their subsequent amendments]</span>
                                        </a>
                                    </h4>
                                </div>
                                <div id="table6" class="panel-collapse collapse" style="clear: both; width: 100%">
                                    <div class="panel-table">
                                        ...
                                        <table class="table table-bordered table-gstr table_psm table6">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="c01" colspan="19">6A. Supplies other than import of goods or goods received from SEZ [Information furnished in Table 3 and 4 of earlier returns]-If
details furnished earlier were incorrect</td>
                                                </tr>
                                                <tr>
                                                     <td colspan="19" class="p0 b0">
                                                        <asp:GridView runat="server" OnRowDataBound="grd6A_RowDataBound" DataKeyNames="ActionCode" CssClass="table table-gstr table_psm table6" ID="grd6A" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                                <asp:BoundField DataField="PurchGSTIN"  ItemStyle-CssClass="c01 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceNo" ItemStyle-CssClass="c02 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceDate" ItemStyle-CssClass="c03 text-center" />
                                                ...
                                                <tr>
                                                    <td class="c01" colspan="19">6B. Supplies by way of import of goods or goods received from SEZ [Information furnished in Table 5 of earlier returns]-If details
furnished earlier were incorrect</td>
                                                </tr>
                                                <tr>
                                                     <td colspan="19" class="p0 b0">
                                                        <asp:GridView runat="server" OnRowDataBound="grd6B_RowDataBound" DataKeyNames="ActionCode"  CssClass="table table-gstr table_psm table6" ID="grd6B" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                                <asp:BoundField DataField="PurchGSTIN"  ItemStyle-CssClass="c01 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceNo" ItemStyle-CssClass="c02 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceDate" ItemStyle-CssClass="c03 text-center" />
                                                              ...
                                                              <%--  <asp:BoundField DataField="" ItemStyle-CssClass="c01 text-center" />
                                                                ...
                                                                <asp:BoundField DataField="" ItemStyle-CssClass="c12 text-center" />
                                                                <asp:BoundField DataField="" ItemStyle-CssClass="c13 text-center" />
                                                                <asp:BoundField DataField="" ItemStyle-CssClass="c14 text-center" />
                                                                <asp:BoundField DataField="" ItemStyle-CssClass="c15 text-center" />
                                                                <asp:BoundField DataField="" ItemStyle-CssClass="c16 text-center" />
                                                                <asp:BoundField DataField="" ItemStyle-CssClass="c17 text-center" />
                                                                <asp:BoundField DataField="" ItemStyle-CssClass="c18 text-center" />
                                                                <asp:BoundField DataField="" ItemStyle-CssClass="c19 text-center" />--%>
                                                            </Columns>
                                                        </asp:GridView>
                                                    </td>
                                                   <%-- <td class="c01">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td colspan="19" class="p0 b0">
                                                        <asp:GridView runat="server" OnRowDataBound="grd6C_RowDataBound" DataKeyNames="ActionCode" CssClass="table table-gstr table_psm table6" ID="grd6C" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                                <asp:BoundField DataField="PurchGSTIN"  ItemStyle-CssClass="c01 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceNo" ItemStyle-CssClass="c02 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceDate" ItemStyle-CssClass="c03 text-center" />
                                                ...
                                                <tr>
                                                    <td colspan="19" class="p0 b0">
                                                        <asp:GridView runat="server" OnRowDataBound="grd6D_RowDataBound" DataKeyNames="ActionCode" CssClass="table table-gstr table_psm table6" ID="grd6D" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                               <asp:BoundField DataField="PurchGSTIN"  ItemStyle-CssClass="c01 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceNo" ItemStyle-CssClass="c02 text-center" />
                                                                <asp:BoundField DataField="CurrInvoiceDate" ItemStyle-CssClass="c03 text-center" />
                                        ...
                                        <table class="table table-bordered table-gstr table_psm table7">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <%-- <td class="c01">7A. Inter-State supplies </td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>--%>
                                              ...
                                              <%--  <tr>
                                                    <td class="c01">7B. Intra-state supplies</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                        ...
                                        <table class="table table-bordered table-gstr table_psm table8">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <%-- <td class="c01">8A. ISD Invoice</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                               ...
                                               <%-- <tr>
                                                ...
                                                <tr>
                                                    <td class="c01">8B. ISD Credit Note</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <%-- <td class="c01">&nbsp;</td>
                                                    ...
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                    <td class="c06" colspan="3">&nbsp;</td>
                                                    <td class="c07" colspan="2">&nbsp;</td>--%>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="c01" colspan="10">10B. Advance amount on which tax was paid in earlier period but invoice has been received in the current period [
reflected in Table 4 above] </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <%-- <td class="c01">Month</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03" colspan="4">Amendment relating to information furnished in S. No.(select)</td>
                                                    <td class="c06">10A(1)</td>
                                                    <td class="c06">10A(2)</td>
                                                    <td class="c07">10(B1)</td>
                                                    <td class="c07">10B(2)</td>--%>
                                                </tr>
                                               <%-- <tr>
                                                    <td class="c01">&nbsp;</td>
                                                    <td class="c02">&nbsp;</td>
                                        ...
                                        <table class="table table-bordered table-gstr table_psm table11">
                                            ...
                                            <tbody>
                                                <tr>
                                                   ...
                                                   <%-- <td class="c01">A. Information for the current tax period</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                              ...
                                              <%--  <tr>
                                                    <td class="c01">(a) Amount in terms of rule 2(2) of ITC Rules</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(b) Amount in terms of rule 4(1)(j)(ii) of ITC Rules</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(c) Amount in terms of rule 7 (1) (m) of ITC Rules</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(d) Amount in terms of rule 8(1) (h) of the ITC Rules</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(e) Amount in terms of rule 7 (2)(a) of ITC Rules</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(f) Amount in terms of rule 7(2)(b) of ITC Rules</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(g) On account of amount paid subsequent to reversal of ITC</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(h) Any other liability (Specify)</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                   ...
                                                   <%-- <td class="c01">Amendment is in respect of information furnished in the Month</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <%--<tr>
                                                    <td class="c01">Specify the information you wish to amend (Drop down)</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                        ...
                                        <table class="table table-bordered table-gstr table_psm tabel12">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <%--<td class="c01">(a)ITC claimed on mismatched/duplication of invoices/debit notes</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                               ...
                                               <%-- <tr>
                                                    <td class="c01">(b)Tax liability on mismatched credit notes</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(c) Amount in termReclaim on account of rectification of mismatched invoices/debit
notes</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(d)Reclaim on account of rectification of mismatched credit note</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(e)Negative tax liability from previous tax periods</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="c01">(f)Tax paid on advance in earlier tax periods and adjusted with tax on
supplies made in current tax period</td>
                                                    <td class="c02">&nbsp;</td>
                                                    <td class="c03">&nbsp;</td>
                                                    <td class="c04">&nbsp;</td>
                                                    <td class="c05">&nbsp;</td>
                                        ...
                                        <table class="table table-bordered table-gstr table_psm table13">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th rowspan="2">HSN</th>
                                                    <th rowspan="2">Description (Optional If HSN Furnished)</th>
                                                    <th rowspan="2">UQC</th>
                                            ...
                                            <tbody>
                                                 <tr>
                                                      <td colspan="11" class="p0 b0">
                                                        <asp:GridView runat="server" ID="grd13" OnRowCreated="grd13_RowCreated" CssClass="table table-gstr table_psm table13" AutoGenerateColumns="false" ShowHeader="false">
                                                            <Columns>
                                                              <asp:TemplateField ItemStyle-Width="4%">
                                                                ...
                                                                <asp:BoundField ItemStyle-Width="9%" DataField="HSNCode" ItemStyle-CssClass="text-left"/>
                                                                <asp:BoundField ItemStyle-Width="14%" DataField="HSNDesc" ItemStyle-CssClass="text-left" />
                                                                <asp:BoundField ItemStyle-Width="9%" DataField="UQC"  ItemStyle-CssClass="text-left" />
                                                                <asp:BoundField ItemStyle-Width="9%" DataField="TotalQuantity" ItemStyle-CssClass="text-right" />
                                                                <asp:BoundField ItemStyle-Width="9%" DataField="TotalValue" ItemStyle-CssClass="text-right" />
                                                                <asp:BoundField ItemStyle-Width="9%" DataField="TaxableValue" ItemStyle-CssClass="text-right" />
                                                                <asp:BoundField ItemStyle-Width="9%" DataField="IGST" ItemStyle-CssClass="text-right" />
                                                                <asp:BoundField ItemStyle-Width="9%" DataField="CGST" ItemStyle-CssClass="text-right" />
                                                                <asp:BoundField ItemStyle-Width="9%" DataField="SGST" ItemStyle-CssClass="text-right" />
                                                                <asp:BoundField ItemStyle-Width="9%" DataField="CESS" ItemStyle-CssClass="text-right" />
