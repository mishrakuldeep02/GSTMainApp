<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucCA.ascx.cs" Inherits="UserControl_wucCA" %>
...
<div class="item user-block">
    <div class="user-block-info">
        ...
        <span class="user-block-role">( CA )</span>
    </div>
</div>
    ...
    <ul class="nav2 nav-list main-nav2">
         ...
         <li class="list-item-1 has-submenu-nav2 navsctooltip liImportExcel"  style="display:none;">
          ...
          <li class="list-item-1 has-submenu-nav2 navsctooltip liImportExcel"  style="display:none;">
            ...
            <ul class="nav2 nav-list collapse" id="GSTR2">
                ...
                <li class="list-item-2 liImportExcel" style="display: none;"><a href="#"><span>Download GSTR-2A Data</span></a></li>
        ...
        <li class="list-item-1 has-submenu-nav2 navsctooltip liImportExcel" style="display:none;">
            ...
            <ul class="nav2 nav-list collapse" id="Ledger">
                <%--<li class="list-item-2 liImportExcel1" style="display:none"><a href="../CA%20Admin/frmExcelImport.aspx"  title="Import Sales Data"><span>Import Sales Data</span></a></li>
                <li class="list-item-2 liImportExcel1" style="display: none;"><a href="../Client/frmImportPurchaseData.aspx"  title="Import Purchase Data"><span>Import Purchase Data</span></a></li>--%>
                <li class="list-item-2 liImportExcel" style="display: none;"><a href="#"  title="Get Cash Ledger Details"><span>Get Cash Ledger Details</span></a></li>
                <li class="list-item-2 liImportExcel" style="display: none;"><a href="#"  title="Get ITC Ledger Details"><span>Get ITC Ledger Details</span></a></li>
                <li class="list-item-2 liImportExcel" style="display: none;"><a href="#"  title="Get Liability Ledger"><span>Get Liability Ledger</span></a></li>
                <li class="list-item-2 liImportExcel" style="display: none;"><a href="#"  title="Details For Return"><span>Details For Return</span></a></li>
                <li class="list-item-2 liImportExcel" style="display: none;"><a href="#"  title="Liability"><span>Liability</span></a></li>
                <li class="list-item-2 liImportExcel" style="display: none;"><a href="#"  title="Get RetLiab Balance"><span>Get RetLiab Balance</span></a></li>
                <li class="list-item-2 liImportExcel" style="display: none;"><a href="#"  title="Get Cash ITC Balance"><span>Get Cash ITC Balance</span></a></li>
                </ul>
        </li>
         <li class="list-item-1 has-submenu-nav2 navsctooltip liImportExcel" style="display:none;">
        ...
        <li class="list-item-1 no-submenu liImportExcel navsctooltip" style="display: none;"><a href="../CA%20Admin/frmRegisterDSC.aspx" class="li-heading"><i class="fa fa-registered  nav2-fa"></i><span class="nav2-text"> Register DSC</span></a></li>
        ...
        <li class="list-item-1 no-submenu liImportExcel navsctooltip"><a href="../Files/GST Return Filing Portal-Help.pdf" target="_blank" class="li-heading"><i class="fa r fa-info-circle  nav2-fa"></i><span class="nav2-text">Help</span></a></li>
    </ul>
</nav>
<%--<div class="item user-block">
    <div class="user-block-info">
